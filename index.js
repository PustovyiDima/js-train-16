...
function filterStudentsByGrade(students, grade) {
   ...
   //  );
   //  console.clear();
   if (Array.isArray(students) && typeof grade == "string") {
      console.log("Завдання: 1 ==============================");
      for (const object of students) {
         object.grade === grade ? console.log(object) : null;
      }
   } else {
      console.clear();
      console.error(
   ...
   //  let arr = [...students];
   //  let res = arr.filter((object) => object.grade === grade);
   return;
}
...
function compareArrays(arr1, arr2) {
   ...
   arr1.sort();
   arr2.sort();
   let jsonArr1 = JSON.stringify(arr1);
   let jsonArr2 = JSON.stringify(arr2);
...
function traceBackward(n) {
   ...
   console.log(n);
   n > 1 ? traceBackward(n - 1) : console.trace("Reached the end");
}
